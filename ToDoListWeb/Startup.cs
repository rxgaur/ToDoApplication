...
namespace ToDoListWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ToDoListDbContext>(options => options.UseInMemoryDatabase("ToDoListApp"));
            //Register Identity database context
            //services.AddDbContext<IdentityDbContext>(options =>
            //    options.UseInMemoryDatabase("ToDoListApp"));
        ...
        //    builder.AddRoles<UserRoleEntity>().AddEntityFrameworkStores<ToDoListDbContext>().AddDefaultTokenProviders()
